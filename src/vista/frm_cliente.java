...
Cliente obj_cliente;
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
     ...
     obj_cliente = new Cliente(this.txt_nit.getText(),this.txt_nombres.getText(),this.txt_apellidos.getText(),this.txt_direccion.getText(),this.txt_telefono.getText(),this.txt_fn.getText());
     obj_cliente.agregar();
